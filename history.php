...
<nav class="navbar navbar-expand-lg navbar-dark bg-light" style="border-bottom:black 10px solid;position:fixed;width:100%;background-image: linear-gradient( 63.1deg,  rgba(5,23,111,1) 8.4%, rgba(24,95,240,1) 64.5% );">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                        ...
                        <li class="nav-item">
                            <h4><a class="nav-link active" href="history.php" style="font-weight:bold;">Transaction History  |</a></h4>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="row row-history color">
            <h2 class="text-center" style="padding-top:77px">Transaction History</h2>
            <br>
